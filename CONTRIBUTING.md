# Contributing to Itasecore

Itasecore is open source software, and we would welcome contributions
which improve the state of the software. For those wanting to discuss changes,
or look for work that needs doing, please see:

* [Help requests](https://github.com/milopms/itasecore/labels/help%20wanted)

## Branch Strategy

Itasecore's default branch is intentionally a stable release, so that anyone
...
Itasecore is a direct fork of Litecoin Core and therefore benefits from as
...
[litecoin-project/litecoin](https://github.com/litecoin-project/litecoin) and future Itasecore
releases will automatically benefit from these.

When refactoring Itasecoin-specific code, please keep refactoring requests short,
low complexity and easy to verify.


## "Decision Making" Process

The following applies to code changes to Itasecore, and is not to be
confused with overall Itasecoin Network Protocol consensus changes. All consensus
...
principles of Itasecoin; meets the minimum standards for inclusion; and will
...
Where a patch set proposes to change the Itasecoin consensus, it must have been
