Itasecoin Core version *0.15.1* is now available from:

  <https://download.itasecoin.org/itasecoin-0.15.1/>
...
A number of changes to the way Itasecoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 itasoshis per kB (0.00001 ITASE). This is to prepare for dropping the minimum transaction fee to 0.1 itasoshis per kB (0.0001 ITASE) in the next release.
