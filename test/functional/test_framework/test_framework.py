...
class BitcoinTestFramework(object):
    """Base class for a itasecoin test script.

    Individual itasecoin test scripts should subclass this class and override the set_test_params() and run_test() methods.
    ...
    def _start_logging(self):
        ...
        if self.options.trace_rpc:
            rpc_logger = logging.getLogger("ItasecoinRPC")
