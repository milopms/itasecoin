...
{
    const char* pszTimestamp = "09/01/22 - Les étoiles seront avec toi";
    const CScript genesisOutputScript = CScript() << ParseHex("04c7e2159a3c2590ca033e3b13b47e3ce47cc4ee144f5306ff20690cebf42c2b9fa7d1a44d5020dce6c14ca8b35a58634cdaef8615b4312d0b6e68928dade2a6a5") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nRuleChangeActivationThreshold = 855; // 75% of 8064
        ...
        consensus.defaultAssumeValid = uint256S("0x00"); //block height
        ...
        genesis = CreateGenesisBlock(1641891485, 1167101, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xd113a2ccf302ec45f5cb51efdcf8bdf2182635e0b0b80e6c5f03e54667d82a5d"));
        ...
        checkpointData = (CCheckpointData) {
            {
                {  0, uint256S("0xd113a2ccf302ec45f5cb51efdcf8bdf2182635e0b0b80e6c5f03e54667d82a5d")},
                {  250, uint256S("0x4f64a30954ab27fa7017c7611da932c81fe708563f01c238a5b98acf19976831")},                
                {  500, uint256S("0xb12dec686ecafddb1eab1cea18432fe3ac25697f5ea3e771be5cea662e32bb1b")},
/*
...
*/
        ...
        chainTxData = ChainTxData{
            ...
            1641891485, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1641892023, 278739, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xab66ca222a0f54e7a87720865f53f0cf2bb62754975836d959b35f3913585533"));
        assert(genesis.hashMerkleRoot == uint256S("0x7deeaea742b3e95d97e01997f2466aa72933554551e25af30fe5e1b12dc0bd76"));
        ...
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,63);
        base58Prefixes[EXT_PUBLIC_KEY] = {0x02, 0x34, 0x87, 0xCF};
        base58Prefixes[EXT_SECRET_KEY] = {0x02, 0x34, 0x83, 0x94};
        ...
        checkpointData = (CCheckpointData) {
            {
                {  0, uint256S("0xab66ca222a0f54e7a87720865f53f0cf2bb62754975836d959b35f3913585533")},
            }
        };
...
public:
    CRegTestParams() {
        ...
        consensus.nPowTargetTimespan = 2 * 60 * 60; // two hours
        consensus.nPowTargetSpacing = 60;
        consensus.fPowAllowMinDifficultyBlocks = true;
