...
#if defined(NDEBUG)
# error "Itasecoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Itasecoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s ITASE additional fees, %d delta bytes\n",
